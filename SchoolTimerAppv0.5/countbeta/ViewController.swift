...
class ViewController: UIViewController {
    @IBOutlet weak var schoolTimer: UILabel!
    ...
    override func viewDidLoad() {
        ...
        //School Timer Label
        let text = schoolTimer.text
        let textRange = NSRange(location: 0, length: (text?.count)!)
        let attributedText = NSMutableAttributedString(string: text!)
        attributedText.addAttribute(NSAttributedString.Key.underlineStyle, value: NSUnderlineStyle.single.rawValue, range: textRange)
        schoolTimer.attributedText = attributedText
       
        
        //color and radius for button a
        buttonA.backgroundColor = UIColor.init(red: 209/255, green: 31/255, blue: 58/255, alpha: 1)
        buttonA.layer.cornerRadius = 10.0
        buttonA.tintColor = UIColor.init(red: 53/255, green: 73/255, blue: 101/255, alpha: 1)
        
        //color and radius for button c
        buttonC.backgroundColor = UIColor.init(red: 209/255, green: 31/255, blue: 58/255, alpha: 1)
        buttonC.layer.cornerRadius = 10.0
        buttonC.tintColor = UIColor.white
        
        //color and radius for button d
        buttonD.backgroundColor = UIColor.init(red: 209/255, green: 31/255, blue: 58/255, alpha: 1)
        buttonD.layer.cornerRadius = 10.0
        buttonD.tintColor = UIColor.white
        
        //color and radius for button W
        buttonW.backgroundColor = UIColor.init(red: 209/255, green: 31/255, blue: 58/255, alpha: 1)
    ...
    @IBAction func buttonC(_ sender: UIButton) {
        ...
        buttonC.tintColor = UIColor.init(red: 53/255, green: 73/255, blue: 101/255, alpha: 1)
        buttonD.tintColor = UIColor.white
        buttonW.tintColor = UIColor.white
    }
    @IBAction func buttonD(_ sender: UIButton) {
        ...
        buttonA.tintColor = UIColor.white
        buttonC.tintColor = UIColor.white
        buttonD.tintColor = UIColor.init(red: 53/255, green: 73/255, blue: 101/255, alpha: 1)
        buttonW.tintColor = UIColor.white
    }
    ...
    @IBAction func buttonW(_ sender: UIButton) {
        ...
        buttonC.tintColor = UIColor.white
        buttonD.tintColor = UIColor.white
        buttonW.tintColor = UIColor.init(red: 53/255, green: 73/255, blue: 101/255, alpha: 1)
    }
    ...
    @objc func update() {
        ...
        if num == 4 {
            ...
            oneWLabel.isHidden = false
            twoWLabel.isHidden = false
            threeWLabel.isHidden = false
            fourWLabel.isHidden = false
            fiveWLabel.isHidden = false
            sixWLabel.isHidden = false
            sevenWLabel.isHidden = false
            eightWLabel.isHidden = false
            nineWLabel.isHidden = false
           
            P1 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p1W), userInfo: nil, repeats: true)
            P2 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p2W), userInfo: nil, repeats: true)
            P3 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p3W), userInfo: nil, repeats: true)
            P4 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p4W), userInfo: nil, repeats: true)
            P5 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p5W), userInfo: nil, repeats: true)
            P6 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p6W), userInfo: nil, repeats: true)
            P7 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p7W), userInfo: nil, repeats: true)
            P8 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p8W), userInfo: nil, repeats: true)
            P9 = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(p9W), userInfo: nil, repeats: true)
    ...
    @objc func p8W() {
        ...
        eventDateComponents8W.minute = 12
